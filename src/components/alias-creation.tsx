    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-50">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Revendiquez votre numéro de téléphone pour recevoir des paiements en toute sécurité.</p>
        </div>
        <Card>
            <CardHeader>
                <CardTitle className='flex items-center gap-2'><Smartphone /> Revendiquer un numéro</CardTitle>
